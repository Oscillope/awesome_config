...
-- active_theme = "/usr/share/awesome/themes/default"

-- Themes define colours, icons, and wallpapers
beautiful.init(active_theme .. "/theme.lua")
-- awful.util.spawn_with_shell("cairo-compmgr &")
awful.util.spawn_with_shell("compton -f --blur-background --blur-kern 7x7box --backend glx -D 4 -m 0.7 -b")
...
tags = {
       ...
       layout = { layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[2], layouts[1] }
       }
--tags2 = {
--       names = { "1", "2", "3", "4", "5", "6", "7", "8" },
--       layout = { layouts[4], layouts[4], layouts[4], layouts[4], layouts[4], layouts[4], layouts[4], layouts[1] }
--       }
...
mytextclock = awful.widget.textclock("<span font=\"DejaVu Sans Mono 8\" color=\"#DDDDFF\"> %a %d %b  %H:%M</span>")
...
vicious.register(cpuwidget, vicious.widgets.cpu, '<span background="#313131" font="Liberation Sans 13" rise="2000"> <span font="Liberation Sans 9">$1% </span></span>', 3)
...
vicious.register(tempwidget, vicious.widgets.thermal, '<span font="Liberation Sans 13" color="#FF6868" rise="2000"> <span font="Liberation Sans 9">$1°C </span></span>', 9, {"coretemp.0", "core"} )
...
function (widget, args)
  if args["{/ used_p}"] >= 95 and args["{/ used_p}"] < 99 then
    return '<span background="#313131" font="Liberation Sans 13" rise="2000"> <span font="Liberation Sans 9">' .. args["{/ used_p}"] .. '% </span></span>' 
...
vicious.register(netwidget, vicious.widgets.net, '<span background="#313131" font="Liberation Sans 13" rise="2000"> <span font="Liberation Sans 9" color="#7AC82E">${eth0 down_kb}</span> <span font="Liberation Sans 7" color="#EEDDDD">↓↑</span> <span font="Liberation Sans 9" color="#46A8C3">${eth0 up_kb} </span></span>', 3)
...
for s = 1, screen.count() do
    ...
    mystatusbar = awful.wibox({ position = "left", screen = s, width =108, height = 1 })
...
globalkeys = awful.util.table.join(
    ...
    -- Change number of displays
    awful.key({ modkey,           }, "F6", function() awful.util.spawn("/home/jason/.screenlayout/default.sh") end),
    awful.key({ modkey,           }, "F7", function() awful.util.spawn("/home/jason/.screenlayout/single_display.sh") end),
...
--     awful.key({ modkey,	          }, "z",     function () scratch.drop(terminal) end),
    ...
    awful.key({ modkey, 	   }, "t", 	    function () awful.util.spawn(tasks) end),
